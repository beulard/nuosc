...
void color_index() {
	...
	new TColor(ci[CI_BACKGROUND], 255. / 255., 255. / 255, 255. / 255.);
	...
	new TColor(ci[CI_E], 50. / 255., 142. / 255., 237. / 255);
	new TColor(ci[CI_MU], 239. / 255., 84. / 255., 138. / 255);
	new TColor(ci[CI_TAU], 134. / 255., 211. / 255., 27. / 255);
